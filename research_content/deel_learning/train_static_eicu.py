...
dataset_tr_0 = EICU_CRD("/home/luojiawei/EMR_LIP_data/eicu_crd/all_stids_share/",
...
dataset_tr_1 = EICU_CRD("/home/luojiawei/EMR_LIP_data/eicu_crd/all_stids_share/",
                "/home/luojiawei/EMR_LIP_data/ds_id_eicu_crd.csv",
                id_col="patientunitstayid",
                mod_col="set",
                mod = [1],
...
dataset_va_0 = EICU_CRD("/home/luojiawei/EMR_LIP_data/eicu_crd/all_stids_share/",
                "/home/luojiawei/EMR_LIP_data/ds_id_eicu_crd.csv",
                id_col="patientunitstayid",
                mod_col="set",
                mod = [3],
...
dataset_va_1 = EICU_CRD("/home/luojiawei/EMR_LIP_data/eicu_crd/all_stids_share/",
                "/home/luojiawei/EMR_LIP_data/ds_id_eicu_crd.csv",
                id_col="patientunitstayid",
                mod_col="set",
                mod = [3],
...
for epoch in range(EPOCHS):
    ...
    with torch.no_grad():
        ...
        if auc > best_auc:
            ...
            torch.save(model.state_dict(), f"/home/luojiawei/EMR_LIP/deep_learning/saved_param_share/{model_name}_eicu_{y_name}" + ".pth")
            no_improvement_count = 0
            print("参数已更新")
        else:
