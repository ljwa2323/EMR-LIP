...
pre_param = None
file_para = f"/home/luojiawei/EMR_LIP/deep_learning/saved_param/{model_name}_eicu_{y_name}.pth"
file_out = f"//home/luojiawei/EMR_LIP/结果文件夹/模型性能/test_{model_name}_eicu_{y_name}.csv"
