...
pre_param = None
file_para = f"/home/luojiawei/EMR_LIP/deep_learning/saved_param/{model_name}_eicu_{y_name}_dym.pth"
file_out = f"//home/luojiawei/EMR_LIP/结果文件夹/模型性能/test_{model_name}_eicu_{y_name}_dym.csv"

# -------  模型参数 -----------
input_size_list = [42 + 41]
...
dataset_te = EICU_CRD("/home/luojiawei/EMR_LIP_data/eicu_crd/all_stids/",
