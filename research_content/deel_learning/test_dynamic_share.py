...
from dataloader import MIMIC_IV, EICU_CRD
from model import *
...
pre_param = None
file_para = f"/home/luojiawei/EMR_LIP/deep_learning/saved_param_share/{model_name}_eicu_{y_name}_dym.pth"
file_out = f"//home/luojiawei/EMR_LIP/结果文件夹/模型性能_share/test_{model_name}_eicu_to_mimic_{y_name}_dym.csv"
